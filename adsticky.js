...
document.addEventListener("DOMContentLoaded", function() {
    ...
    <div class="fixed bottom-0 left-0 right-0 md:bottom-6 md:right-6 md:left-auto z-[2000] group max-w-full md:max-w-sm">
        ...
        <a href="../sly" target="_blank" rel="noopener nofollow" class="flex items-center flex-grow min-w-0 text-decoration-none" onclick="const ad = this.closest('#sticky-e-sim-ad'); setTimeout(() => { if(ad) ad.remove(); }, 300);">
